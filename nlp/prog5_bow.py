    ...
    def predict_one(self, text):
        ...
        for cls in self.classes:
            ...
            for word in words:
                ...
                prob   = (count + self.alpha) / (self.total_words[cls] + self.alpha * self.vocab_size)
...
new_reviews = ["This guitar sounds amazing, the tone is perfect and build quality is excellent",
